import { Heart, Lightbulb, Target, UserCheck, Award, BookOpen } from 'lucide-react';
        ...
        <div className="container-max">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-5 -right-5 bg-brand-700 text-white rounded-xl p-5 shadow-lg hidden md:block">
                <Award className="w-6 h-6 mb-1" />
                <p className="font-bold">{t.about.personalized}</p>
                <p className="text-brand-200 text-sm">{t.aboutPage.learningPlans}</p>
              </div>
            </div>
          </div>
        </div>
