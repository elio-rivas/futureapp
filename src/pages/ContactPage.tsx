...
const CONTACT_EMAIL = 'futurefoundations.edu@gmail.com';
...
export default function ContactPage() {
  ...
  const handleSubmit = async (
    ...
    try {
      /*
       * The deployed Supabase function accepts the
       * standard lead fields.
       *
       * Additional information is included in the
       * message so it reaches FFE without requiring
       * changes to the working backend.
       */
      const additionalDetails = [
        ...
        form.preferredContact.trim()
          ? `Preferred contact: ${form.preferredContact.trim()}`
          : '',
      ].filter(Boolean);
  ...
  const successDescription = isSpanish
  ...
  const savedTitle = t.leadSubmission.savedTitle;
  ...
  const getErrorMessage = () => {
    if (
      ...
      return t.leadSubmission.reviewRequired;
    }

    if (errorCode === 'invalid_input') {
      return t.leadSubmission.invalidInput;
    }

    return t.leadSubmission.error;
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="bg-warm-50 rounded-2xl p-6 border border-warm-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-brand-900 text-base uppercase tracking-wider">
                    {c.valueTitle}
                  </h3>
                </div>
                  ...
                  {[
                    {
                      ...
                      label: c.connectTextWhatsapp,
                    },
                    {
                      icon: <Mail className="w-4 h-4" />,
                      label: c.connectEmail,
                    },
                    {
                      icon: <Send className="w-4 h-4" />,
                      label: c.connectRequest,
                    },
                  ].map((item) => (
                    <div
                      key={item.label}
                      className="flex items-center gap-2 bg-white border border-warm-200 rounded-lg px-3 py-2 text-sm font-medium text-brand-800"
                    >
                      {item.icon}
                      {item.label}
                    </div>
            ...
            <div className="flex items-center justify-center">
              <div className="bg-white rounded-3xl p-10 md:p-12 text-center shadow-2xl max-w-sm w-full relative overflow-hidden">
                ...
                <p className="text-accent-600 font-bold text-lg uppercase tracking-widest mb-5">
                  Education
                </p>
                ...
                <p className="font-display italic text-brand-800 text-lg leading-snug">
                  ...
                  <span className="text-accent-600 font-bold not-italic">
                    {c.tagline3}
                  </span>
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="border-2 border-brand-200 rounded-2xl p-7 flex flex-col gap-4 hover:border-brand-400 transition-colors">
              ...
              <div className="text-center">
                <h3 className="font-bold text-brand-900 text-base uppercase tracking-wider mb-3">
                  {c.learningCenter}
                </h3>
                ...
                <div className="flex items-start gap-2 justify-center mb-1">
                  ...
                  <div className="text-left">
                    <p className="text-brand-700 text-sm font-medium">
                      {c.learningCenterAddr1}
                    </p>

                    <p className="text-brand-700 text-sm">
                      {c.learningCenterAddr2}
                    </p>
                  </div>
                </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              >
                ...
                {item.contact && (
                  <p
                    className={`font-bold text-base break-all w-full ${
                      item.accent
                        ? 'text-white'
                        : 'text-accent-600'
                    }`}
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            ...
            <div className="lg:col-span-3">
              ...
              status === 'saved' ? (
                 ...
                 * Final confirmation.
                 *
                 * No additional enrollment button.
                 * No Jotform link.
                 * No second step.
                 */
                ...
                <div
                  role="status"
                  aria-live="polite"
                  className="border-2 border-success-300 bg-success-50 rounded-2xl p-10 text-center"
                >
                  <CheckCircle className="w-14 h-14 text-success-500 mx-auto mb-4" />

                  <h3 className="font-display font-bold text-2xl text-brand-900 mb-3">
                    {status === 'saved'
                      ? savedTitle
                      : successTitle}
                  </h3>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  >
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        <label
                          htmlFor="contact-parent-name"
                          className="block text-xs font-bold text-brand-700 uppercase tracking-wider mb-1.5"
                        >
                          {c.formParentName}{' '}
                    ...
                    {status === 'error' && (
                      <p
                        role="alert"
                        className="text-error-600 text-sm font-medium bg-error-50 border border-error-200 rounded-xl p-3"
                      >
                        {getErrorMessage()}
                      </p>
                    )}
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="bg-brand-900 rounded-2xl p-7 text-white">
                ...
                <p className="text-brand-300 text-xs uppercase tracking-widest mb-5">
                  {c.serveSubtitle}
                </p>
                ...
                <div className="absolute inset-0 pointer-events-none flex flex-col justify-center items-end pr-3 gap-2.5">
                  ...
                  <div className="pointer-events-auto flex items-center gap-2 bg-white border border-brand-100 text-brand-800 px-3 py-2 rounded-lg shadow-lg text-xs font-semibold leading-snug max-w-[200px]">
                    ...
                    <div>
                      ...
                      <div className="font-normal text-brand-500">
                        {c.mapOnlineNote}
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-warm-50 border border-warm-200 rounded-2xl p-6 space-y-3">
                ...
                <a
                  ...
                  className="flex items-center gap-3 text-sm text-brand-700 hover:text-brand-900 transition-colors group"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-3 text-sm text-brand-700 hover:text-brand-900 transition-colors group break-all"
                >
            ...
            <div className="flex flex-col items-center gap-5 flex-shrink-0">
                ...
                onClick={() => {
                  ...
                  openLeadModal({
                    defaultService:
                      'Appointment request',
                    defaultMessage:
                      'I am interested in an appointment.',
                  });
                }}
              ...
              <div className="flex flex-wrap justify-center gap-6">
                {[
                  ...
                  <div
                    key={item.label}
                    className="flex items-center gap-2 text-brand-600 text-sm"
                  >
